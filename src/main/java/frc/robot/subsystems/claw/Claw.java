...
public class Claw extends SubsystemBase {
  ...
  public void ejectCoralL1() {
    clawMotor.set(ClawConstants.CLAW_MOTOR_SPEED_L1 * -1);
  }

  public void ejectCoralL2() {
    clawMotor.set(ClawConstants.CLAW_MOTOR_SPEED_L2 * -1);
  }

  public void ejectCoralL3() {
    clawMotor.set(ClawConstants.CLAW_MOTOR_SPEED_L3 * -1);
  }

  public void ejectCoralL4() {
    clawMotor.set(ClawConstants.CLAW_MOTOR_SPEED_L4 * -1);
  }
  ...
  public void brakeAlgae() {
    intakeAlgae();
    // clawMotor.set(ClawConstants.CLAW_BRAKE_SPEED * -5.0);
  }
