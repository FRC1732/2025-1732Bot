...
public class L1ScorerConstants {
  ...
  public static final double TILT_KP = 0.005; // to be assigned
  public static final double TILT_KI = 0.0; // to be assigned
  public static final double TILT_KD = 0.0; // to be assigned
  public static final double TILT_KG = 0.0; // to be assigned

  public static final double INTAKE_SPEED = -0.3;
  public static final double EJECT_SPEED = 0.3;
  public static final double TILT_SPEED = 0.40;

  public static final double START_ANGLE = 0.0; // to be assigned
  public static final double HOLD_ANGLE = 5.0; // to be assigned
  public static final double SCORE_ANGLE = 21.0; // to be assigned
  public static final double INTAKE_ANGLE = 105.0; // to be assigned
