...
public class Armevator extends SubsystemBase {
  ...
  public Armevator() {
    ...
    armMap.put(ArmevatorPose.CORAL_AUTO_STAGE, 40.0);
    ...
    armMap.put(
        ArmevatorPose.ALGAE_PRE_PLUCK, -90.0); // TODO I just guessed for this value, check later
    ...
    elevatorMap.put(ArmevatorPose.CORAL_HP_LOAD, 4.25);
    ...
    elevatorMap.put(
        ArmevatorPose.ALGAE_PRE_PLUCK, 15.0); // TODO I just guessed for this value, check later
